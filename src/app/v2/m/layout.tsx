// Серверный layout мобильной версии: перекрывает PWA-метаданные корня
// (манифест со start_url /v2/m/my вместо десктопного /v2/my) и монтирует
// клиентскую оболочку с нижним таб-баром. Экраны /v2/m/* живут внутри /v2/layout.tsx,
