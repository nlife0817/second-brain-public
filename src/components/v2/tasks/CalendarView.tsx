...
/**
 * Подключённые календари и их события за окно.
 *
 * Ошибку наружу отдаём мягко: внешний слой — дополнение к задачам, и упавший
 * синк не повод прятать календарь целиком.
 */
function useExternalCalendars(range: DayRange) {
