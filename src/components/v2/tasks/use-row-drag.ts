...
// Перетаскивание строк в вертикальном списке — общее для настроек колонок,
// порядка групп, секции подзадач и списка проектов в панели. Реализация на
// событиях указателя, а не на dnd-kit: списки здесь короткие и живут внутри
// поповера, карточки и сайдбара, а dnd-kit пересчитывает своих draggable на
