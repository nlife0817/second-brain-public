...
- [src/components/v2/sheet/](src/components/v2/sheet/) — редактор таблиц базы знаний: полотно с виртуализацией, строка формул, панель оформления, вкладки листов. Чистое ядро (модель книги, формулы, форматы, разбор xlsx и csv) — в [src/lib/core/sheet/](src/lib/core/sheet/)
